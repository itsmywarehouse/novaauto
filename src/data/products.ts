...
export const products: Product[] = [
  ...
  },
  {
    ...
    categories: ['jcb-3dx', 'jcb-3d'],
    subCategories: ['Bushes'],
    description: 'Heavy-duty bucket bush built for strength and durability. Designed to handle high loads and ensure smooth movement in JCB 3DX and 3D machines.',
  ...
  },
  {
    ...
    description: 'Premium tapered roller bearing set from Rapid Bearing for JCB N/M (New Model) applications. Designed to handle high radial and axial loads with superior durability. Features precision-ground raceways and rollers for smooth, vibration-free operation. Manufactured to strict quality standards for extended service life under demanding conditions.',
  ...
  },
  {
    ...
    categories: ['jcb-3d'],
    subCategories: ['Pivot Pins'],
    description: 'Precision-machined pivot pin set for JCB 3D backhoe loaders. Manufactured from high-grade steel with hardened surface treatment for maximum wear resistance. Designed to provide smooth articulation and long service life in demanding applications. Complete set includes all necessary pins for boom, dipper, and bucket assemblies.',
  ...
  },
  {
    ...
    description: 'Complete seal kit for JCB 3DX hydraulic systems and cylinders. Includes all necessary O-rings, seals, and gaskets for major service intervals. Manufactured from high-quality materials resistant to hydraulic fluids and temperature extremes. Ensures proper sealing and prevents costly hydraulic fluid leaks.',
